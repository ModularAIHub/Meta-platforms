    ...
    <div className="max-w-6xl space-y-6">
      ...
      <div className="card space-y-4">
        ...
        <p className="text-xs text-gray-500">
          Optional cross-post targets (from Threads):
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <button
            ...
            aria-pressed={postThreadsToX}
            disabled={crossPostRequiresThreads || xToggleDisabled}
            className={`rounded-xl border px-4 py-3 text-left transition ${
              postThreadsToX
                ? 'border-blue-300 bg-blue-50'
                : 'border-gray-200 bg-white hover:border-gray-300'
            } ${crossPostRequiresThreads || xToggleDisabled ? 'cursor-not-allowed opacity-70' : ''}`}
          >
            <div className="flex items-start justify-between gap-2">
              <span className="inline-flex items-center gap-2 text-sm font-semibold text-gray-800">
            ...
            <p className="mt-2 text-xs text-gray-500">Cross-post target from Threads</p>
            <p className="mt-1 text-xs text-gray-500">{xCrossPostStatusDisplay}</p>
          </button>
          ...
          <button
            ...
            aria-pressed={postThreadsToLinkedIn}
            disabled={crossPostRequiresThreads || linkedinToggleDisabled}
            className={`rounded-xl border px-4 py-3 text-left transition ${
              postThreadsToLinkedIn
                ? 'border-blue-300 bg-blue-50'
                : 'border-gray-200 bg-white hover:border-gray-300'
            } ${crossPostRequiresThreads || linkedinToggleDisabled ? 'cursor-not-allowed opacity-70' : ''}`}
          >
            <div className="flex items-start justify-between gap-2">
              <span className="inline-flex items-center gap-2 text-sm font-semibold text-gray-800">
            ...
            <p className="mt-2 text-xs text-gray-500">Cross-post target from Threads</p>
            <p className="mt-1 text-xs text-gray-500">{linkedinCrossPostStatusDisplay}</p>
          </button>
        </div>
          ...
          <div className="rounded-lg border border-gray-200 bg-gray-50 p-3 space-y-3">
            {postThreadsToX && xCrossPostAvailable && xTargetAccounts.length > 0 && (
              <label className="block text-xs text-gray-700">
                ...
                <select
                  className="mt-1 w-full rounded-md border border-gray-200 bg-white px-2 py-1.5 text-xs text-gray-700"
            ...
            {postThreadsToLinkedIn && linkedinCrossPostAvailable && linkedinTargetAccounts.length > 0 && (
              <label className="block text-xs text-gray-700">
                <span className="font-medium">LinkedIn account</span>
                <select
                  className="mt-1 w-full rounded-md border border-gray-200 bg-white px-2 py-1.5 text-xs text-gray-700"
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                <p className="text-xs font-medium text-gray-800">Optimize cross-post formatting</p>
                <p className="text-xs text-gray-500">Adjust punctuation and breaks for target platforms.</p>
              </div>
              <ToggleSwitch
